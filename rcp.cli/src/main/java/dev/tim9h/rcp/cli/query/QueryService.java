...
public class QueryService {
	...
	private static HttpsURLConnection getConnection(String urlString, String query) throws IOException {
		var url = new URL(String.format(urlString, URLEncoder.encode(query, StandardCharsets.UTF_8)));
